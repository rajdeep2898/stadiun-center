...
function BetCard(props) {
    ...
    const { betTime = "", team1 = "Chennai Super Kings", team2 = "Delhi Capitals", selectedTeam = "Delhi Capitals", selectedPoints = 6, isSettled, betWon, isNoResult = false, team1Abbreviation, team2Abbreviation } = bet;
